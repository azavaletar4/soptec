  ...
  <AppLayout>
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
      <div>
        ...
        <p class="text-slate-400 text-sm mt-1">Gestiona equipos devueltos por clientes: dañados, en reparación o listos para reasignar.</p>
      </div>
    </div>
    ...
    <div class="flex flex-wrap gap-2 mb-4">
      <button
        ...
        :class="activeTab === t.value ? 'bg-sky-500 text-slate-950' : 'bg-slate-900 text-slate-400 hover:text-slate-100'"
    ...
    <p v-if="listError" class="mb-4 text-sm text-red-400">{{ listError }}</p>
    ...
    <div class="table-shell">
      <table class="w-full text-sm min-w-[760px]">
        ...
        <tbody>
          ...
          <tr v-for="u in filteredUnits" :key="u.id" class="border-t border-slate-800">
            <td class="px-4 py-3">
              <router-link :to="`/inventario/${u.product_id}`" class="text-sky-400 hover:underline">{{ u.product?.name ?? 'Equipo' }}</router-link>
            </td>
